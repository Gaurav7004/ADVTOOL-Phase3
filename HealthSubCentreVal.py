...
def HSC_Validate(self, df_):
    ...
    def res1(df):
        ...
        elif pd.isnull(df['col_1.1.1']) or pd.isnull(df['col_1.1']):
            if pd.isnull(df['col_1.1.1']):
                return str(incBlnk + ' ' + '1.1.1' + ' (' + str(df['col_1.1.1']) + ' ) ' + '<=' + '1.1' + ' (' + str(df['col_1.1']) + ' ) ')
            elif pd.isnull(float(df['col_1.1'])):
                return str(incBlnk + ' ' + '1.1.1' + ' (' + str(df['col_1.1.1']) + ' ) ' + '<=' + '1.1' + ' (' + str(df['col_1.1']) + ' ) ')
        ...
        # If value exists for all the elements
            ...
            return str(con + ' ' + '1.1.1' + ' (' + str(df['col_1.1.1']) + ' ) ' + '<=' + '1.1' + ' (' + str(df['col_1.1']) + ' ) ')
    ...
    def res2(df):
        ...
        # If any one element is null
        elif pd.isnull(df['col_1.1.2']) or pd.isnull(df['col_1.1']):
            if pd.isnull(df['col_1.1.2']):
        ...
        # Consistent
            ...
            return str(con + ' ' + '1.1.2' + ' (' + str(df['col_1.1.2']) + ' ) ' + '>=' + '1.1' + ' (' + str(df['col_1.1']) + ' ) ')
    ...
    def res3(df):
        ...
        # If any one element is null
        elif pd.isnull(df['col_1.1.2']) or pd.isnull(df['col_1.2.1']) or pd.isnull(df['col_1.2.2']) or pd.isnull(df['col_1.2.3']):
            if pd.isnull(df['col_1.1.2']):
                return str(incBlnk + ' ' + '1.1.2' + ' (' + str(df['col_1.1.2']) + ' ) ' + '>=' + '1.2.1' + ' (' + str(df['col_1.2.1']) + ' ) ' + ' + ' + '1.2.2' + ' (' + str(df['col_1.2.2']) + ' ) ' + ' + ' + '1.2.3' + ' (' + str(df['col_1.2.3']) + ' ) ' )
            elif pd.isnull(df['col_1.2.1']) or pd.isnull(df['col_1.2.2']) or pd.isnull(df['col_1.2.3']):
                return str(incBlnk + ' ' + '1.1.2' + ' (' + str(df['col_1.1.2']) + ' ) ' + '>=' + '1.2.1' + ' (' + str(df['col_1.2.1']) + ' ) ' + ' + ' + '1.2.2' + ' (' + str(df['col_1.2.2']) + ' ) ' + ' + ' + '1.2.3' + ' (' + str(df['col_1.2.3']) + ' ) ' )
        ...
        # Consistent
            ...
            return str(con + ' ' + '1.1.2' + ' (' + str(df['col_1.1.2']) + ' ) ' + '<' + '1.2.1' + ' (' + str(df['col_1.2.1']) + ' ) ' + ' + ' + '1.2.2' + ' (' + str(df['col_1.2.2']) + ' ) ' + ' + ' + '1.2.3' + ' (' + str(df['col_1.2.3']) + ' ) ' )
    ...
    def res4(df):
        ...
        # If any one element is null
        elif pd.isnull(df['col_1.5.1']) or pd.isnull(df['col_1.5.2']):
            if pd.isnull(df['col_1.5.1']):
                return str(incBlnk + ' ' + '1.5.1' + ' (' + str(df['col_1.5.1']) + ' ) ' + '>=' + '1.5.2' + ' (' + str(df['col_1.5.2']) + ' ) ')
            elif pd.isnull(float(df['col_1.5.2'])):
                return str(incBlnk + ' ' + '1.5.1' + ' (' + str(df['col_1.5.1']) + ' ) ' + '>=' + '1.5.2' + ' (' + str(df['col_1.5.2']) + ' ) ')
        ...
        # Consistent
            ...
            return str(con + ' ' + '1.5.1' + ' (' + str(df['col_1.5.1']) + ' ) ' + '>=' + '1.5.2' + ' (' + str(df['col_1.5.2']) + ' ) ')
    ...
    def res5(df):
        ...
        # If any one element is null
        elif pd.isnull(df['col_1.6.1.a']) or pd.isnull(df['col_1.6.1.b']):
            if pd.isnull(df['col_1.6.1.a']):
                return str(incBlnk + ' ' + '1.6.1.a' + ' (' + str(df['col_1.6.1.a']) + ' ) ' + '>=' + '1.6.1.b' + ' (' + str(df['col_1.6.1.b']) + ' ) ')
            elif pd.isnull(float(df['col_1.6.1.b'])):
                return str(incBlnk + ' ' + '1.6.1.a' + ' (' + str(df['col_1.6.1.a']) + ' ) ' + '>=' + '1.6.1.b' + ' (' + str(df['col_1.6.1.b']) + ' ) ')
        ...
        # Consistent
            ...
            return str(con + ' ' + '1.6.1.a' + ' (' + str(df['col_1.6.1.a']) + ' ) ' + '>=' + '1.6.1.b' + ' (' + str(df['col_1.6.1.b']) + ' ) ')
    ...
    def res6(df):
        # If all elements are null
        if pd.isnull(df['col_1.6.1.d']) and pd.isnull(df['col_3.1.1.a']) or pd.isnull(df['col_3.1.1.b'])  :
            return str(blnk  + ' ' + '1.6.1.d' + ' (' + str(df['col_1.6.1.d']) + ' ) ' + '<=' + '3.1.1.a' + ' (' + str(df['col_3.1.1.a']) + ' ) ' + ' + ' + '3.1.1.b' + ' (' + str(df['col_3.1.1.b']) + ' ) ')

        # If any one element is null
        elif pd.isnull(df['col_1.6.1.d']) or pd.isnull(df['col_3.1.1.a']) or pd.isnull(df['col_3.1.1.b']) :
            if pd.isnull(df['col_1.6.1.d']):
                return str(incBlnk  + ' ' + '1.6.1.d' + ' (' + str(df['col_1.6.1.d']) + ' ) ' + '<=' + '3.1.1.a' + ' (' + str(df['col_3.1.1.a']) + ' ) ' + ' + ' + '3.1.1.b' + ' (' + str(df['col_3.1.1.b']) + ' ) ')
            elif pd.isnull(float(df['col_1.6.1.b'])) or pd.isnull(float(df['col_1.6.1.b'])):
                return str(incBlnk  + ' ' + '1.6.1.a' + ' (' + str(df['col_1.6.1.a']) + ' ) ' + '<=' + '3.1.1.a' + ' (' + str(df['col_3.1.1.a']) + ' ) ' + ' + '  + '3.1.1.b' + ' (' + str(df['col_3.1.1.b']) + ' ) ')
        
        # Inconsistent
        elif df['col_1.6.1.d'] > df['col_3.1.1.a'] + df['col_3.1.1.b']:
            return str(inc + ' ' + '1.6.1.d' + ' (' + str(df['col_1.6.1.d']) + ' ) ' + '>' + ' ' + '3.1.1.a (' + str(df['col_3.1.1.a']) + ' ) ' + ' + '  + ' ' +  '3.1.1.a (' + str(df['col_3.1.1.a']) + ' ) ')
        
        # Consistent
        elif df['col_1.6.1.d'] <= df['col_3.1.1.a'] + df['col_3.1.1.b']:
            return str(con + ' ' + '1.6.1.d' + ' (' + str(df['col_1.6.1.d']) + ' ) ' + '<=' + ' ' + '3.1.1.a (' + str(df['col_3.1.1.a']) + ' ) ' + ' + '  + ' ' +  '3.1.1.a (' + str(df['col_3.1.1.a']) + ' ) ')
    ...
    def res7(df):
        ...
        # If any one element is null
        elif pd.isnull(df['col_1.7.1']) or pd.isnull(df['col_1.7.2']):
            if pd.isnull(df['col_1.7.1']):
                return str(incBlnk + ' ' + '1.7.1' + ' (' + str(df['col_1.7.1']) + ' ) ' + '>=' + '1.7.2' + ' (' + str(df['col_1.7.2']) + ' ) ')
            elif pd.isnull(float(df['col_1.7.2'])):
                return str(incBlnk + ' ' + '1.7.1' + ' (' + str(df['col_1.7.1']) + ' ) ' + '>=' + '1.7.2' + ' (' + str(df['col_1.7.2']) + ' ) ')
        ...
        # Consistent
            ...
            return str(con + ' ' + '1.7.1' + ' (' + str(df['col_1.7.1']) + ' ) ' + '>=' + '1.7.2' + ' (' + str(df['col_1.7.2']) + ' ) ')
    ...
    def res8(df):
        ...
        # If any one element is null
        elif pd.isnull(df['col_1.8.1.a']) or pd.isnull(df['col_1.8.1.b']) or pd.isnull(df['col_1.8.1.c']) or pd.isnull(df['col_1.8.1.d']) or pd.isnull(df['col_2.2']):
            if pd.isnull(df['col_1.8.1.a']) or pd.isnull(df['col_1.8.1.b']) or pd.isnull(df['col_1.8.1.c']) or pd.isnull(df['col_1.8.1.d']):
            ...
            elif pd.isnull(float(df['col_2.2'])):
                return str(incBlnk  + ' ' + '1.8.1.a' + ' (' + str(df['col_1.8.1.a']) + ' ) ' + ' + '  + ' ' + '1.8.1.b' + ' (' + str(df['col_1.8.1.b']) + ' ) ' + ' + '  + ' ' + '1.8.1.c' + ' (' + str(df['col_1.8.1.c']) + ' ) ' + ' + '  + ' ' + '1.8.1.d' + ' (' + str(df['col_1.8.1.d']) + ' ) ' + '<=' + ' ' + '2.2' + ' (' + str(df['col_2.2']) + ' ) ')
        
        # Inconsistent
        elif df['col_1.8.1.a'] + df['col_1.8.1.b'] + df['col_1.8.1.c'] + df['col_1.8.1.d'] > df['col_2.2']:
        ...
        # Consistent
            ...
            return str(con + ' ' + '1.8.1.a' + ' (' + str(df['col_1.8.1.a']) + ' ) ' + ' + ' + '1.8.1.b' + ' (' + str(df['col_1.8.1.b']) + ' ) ' + ' + '  + '1.8.1.c'  + ' (' + str(df['col_1.8.1.c']) + ' ) ' + ' + '  + '1.8.1.d'  + ' (' + str(df['col_1.8.1.d']) + ' ) ' + '<=' + '2.2' + ' (' + str(df['col_2.2']) + ' ) ')
    ...
    def res9(df):
        ...
        # If any one element is null
        elif pd.isnull(df['col_2.2.1']) or pd.isnull(df['col_2.2']):
            if pd.isnull(df['col_2.2.1']):
        ...
        # Consistent
            ...
            return str(con  + ' ' + '2.2.1' + ' (' + str(df['col_2.2.1']) + ' ) ' + '<=' + '2.2' + ' (' + str(df['col_2.2']) + ' ) ')
    ...
    def res10(df):
        ...
        # If any one element is null
        elif pd.isnull(df['col_2.2.2']) or pd.isnull(df['col_2.2']):
            if pd.isnull(df['col_2.2.2']):
        ...
        # Consistent
            ...
            return str(con  + ' ' + '2.2.2' + ' (' + str(df['col_2.2.2']) + ' ) ' + '<=' + '2.2' + ' (' + str(df['col_2.2']) + ' ) ')
    ...
    def res11(df):
        ...
        # If any one element is null
        elif pd.isnull(df['col_3.1.1.a']) or pd.isnull(df['col_3.1.1.b']) or pd.isnull(df['col_3.1.3.b']) or pd.isnull(df['col_2.2']) or pd.isnull(df['col_2.1.1.a']) or pd.isnull(df['col_2.1.1.b']):
            if pd.isnull(df['col_3.1.1.a']) or pd.isnull(df['col_3.1.1.b']) or pd.isnull(df['col_3.1.3.b']):
            ...
            elif pd.isnull(float(df['col_2.2'])) or pd.isnull(df['col_2.1.1.a']) or pd.isnull(df['col_2.1.1.b']):
                return str(incBlnk  + ' ' + '3.1.1.a' + ' (' + str(df['col_3.1.1.a']) + ' ) ' + ' + ' + '3.1.1.b' + ' (' + str(df['col_3.1.1.b']) + ' ) ' + ' + ' + ' ' + '3.1.3.b' + ' (' + str(df['col_3.1.3.b']) + ' ) ' + '>=' + ' ' + '2.2' + ' (' + str(df['col_2.2']) + ' ) ' + ' + ' + '2.1.1.a' + ' (' + str(df['col_2.1.1.a']) + ' ) ' + ' + ' + ' ' + '2.1.1.b' + ' (' + str(df['col_2.1.1.b']) + ' ) ' )
        
        # Inconsistent
        elif df['col_3.1.1.a'] + df['col_3.1.1.b'] + df['col_3.1.3.b'] < df['col_2.2'] + df['col_2.1.1.a'] + df['col_2.1.1.b']:
        ...
        # Consistent
            ...
            return str(con + ' ' + '3.1.1.a' + ' (' + str(df['col_3.1.1.a']) + ' ) ' + ' + ' + '3.1.1.b' + ' (' + str(df['col_3.1.1.b']) + ' ) ' + ' + ' + ' ' + '3.1.3.b' + ' (' + str(df['col_3.1.3.b']) + ' ) ' + '>=' + ' ' + '2.2' + ' (' + str(df['col_2.2']) + ' ) ' + ' + ' + '2.1.1.a' + ' (' + str(df['col_2.1.1.a']) + ' ) ' + ' + ' + ' ' + '2.1.1.b' + ' (' + str(df['col_2.1.1.b']) + ' ) ' )
    ...
    def res12(df):
        ...
        # If any one element is null
        elif pd.isnull(df['col_3.1.2']) or pd.isnull(df['col_3.1.1.a']) or pd.isnull(df['col_3.1.1.b']):
            if pd.isnull(df['col_3.1.2']):
                return str(incBlnk  + ' ' + '3.1.2' + ' (' + str(df['col_3.1.2']) + ' ) ' + '<=' + '3.1.1.a' + ' (' + str(df['col_3.1.1.a']) + ' ) ' + ' + ' + '3.1.1.b' + ' (' + str(df['col_3.1.1.b']) + ' ) ')
            elif pd.isnull(df['col_3.1.1.a']) or pd.isnull(df['col_3.1.1.b']):
                return str(incBlnk  + ' ' + '3.1.2' + ' (' + str(df['col_3.1.2']) + ' ) ' + '<=' + '3.1.1.a' + ' (' + str(df['col_3.1.1.a']) + ' ) ' + ' + ' + '3.1.1.b' + ' (' + str(df['col_3.1.1.b']) + ' ) ')
    ...
    def res13(df):
        ...
        # If any one element is null
        elif pd.isnull(df['col_2.3']) or pd.isnull(df['col_2.2']) or pd.isnull(df['col_2.1.1.a']) or pd.isnull(df['col_2.1.1.b']) :
            if pd.isnull(df['col_2.3']):
                return str(incBlnk  + ' ' + '2.3' + ' (' + str(df['col_2.3']) + ' ) ' + '==' + ' ' + '2.2 (' + str(df['col_2.2']) + ' ) ' + ' + ' + ' ' +  '2.1.1.a (' + str(df['col_2.1.1.a']) + ' ) ' + ' + ' + ' ' +  '2.1.1.b (' + str(df['col_2.1.1.b']) + ' ) ')
            elif pd.isnull(float(df['col_1.6.1.b'])) or pd.isnull(float(df['col_1.6.1.b'])):
                return str(incBlnk  + ' ' + '2.3' + ' (' + str(df['col_2.3']) + ' ) ' + '==' + ' ' + '2.2 (' + str(df['col_2.2']) + ' ) ' + ' + ' + ' ' +  '2.1.1.a (' + str(df['col_2.1.1.a']) + ' ) ' + ' + ' + ' ' +  '2.1.1.b (' + str(df['col_2.1.1.b']) + ' ) ')
        
        # Inconsistent
        elif df['col_2.3'] != df['col_2.2'] + df['col_2.1.1.a'] + df['col_2.1.1.b']:
            return str(inc + ' ' + '2.3' + ' (' + str(df['col_2.3']) + ' ) ' + '!=' + ' ' + '2.2 (' + str(df['col_2.2']) + ' ) ' + ' + ' + ' ' +  '2.1.1.a (' + str(df['col_2.1.1.a']) + ' ) ' + ' + ' + ' ' +  '2.1.1.b (' + str(df['col_2.1.1.b']) + ' ) ')
        
        # Consistent
        elif df['col_2.3'] == df['col_2.2'] + df['col_2.1.1.a'] + df['col_2.1.1.b']:
            return str(con + ' ' + '2.3' + ' (' + str(df['col_2.3']) + ' ) ' + '==' + ' ' + '2.2 (' + str(df['col_2.2']) + ' ) ' + ' + ' + ' ' +  '2.1.1.a (' + str(df['col_2.1.1.a']) + ' ) ' + ' + ' + ' ' +  '2.1.1.b (' + str(df['col_2.1.1.b']) + ' ) ')
    ...
    def res14(df):
        ...
        if pd.isnull(df['col_3.1.1.a']) and pd.isnull(df['col_3.1.1.b']) and pd.isnull(df['col_3.1.3.a']) and pd.isnull(df['col_3.1.3.b']) and pd.isnull(df['col_2.2']) and pd.isnull(df['col_2.1.1.a']) and pd.isnull(df['col_2.1.1.b']) :
            return str(blnk  + ' ' + '3.1.1.a' + ' (' + str(df['col_3.1.1.a']) + ' ) ' + ' + ' + ' ' + '3.1.1.b' + ' (' + str(df['col_3.1.1.b']) + ' ) ' + ' + ' + ' ' + '3.1.3.a' + ' (' + str(df['col_3.1.3.a']) + ' ) ' + ' + ' + ' ' + '3.1.3.b' + ' (' + str(df['col_3.1.3.b']) + ' ) '  + '>=' + '2.2' + ' (' + str(df['col_2.2']) + ' ) ' + ' + ' + '2.1.1.a' + ' (' + str(df['col_2.1.1.a']) + ' ) ' + ' + ' + '2.1.1.b' + ' (' + str(df['col_2.1.1.b']) + ' ) ')

        # If any one element is null
        elif pd.isnull(df['col_3.1.1.a']) or pd.isnull(df['col_3.1.1.b']) or pd.isnull(df['col_3.1.3.a']) or pd.isnull(df['col_3.1.3.b']) or pd.isnull(df['col_2.2']) or pd.isnull(df['col_2.1.1.a']) or pd.isnull(df['col_2.1.1.b']) :
            if pd.isnull(df['col_3.1.1.a']) or pd.isnull(df['col_3.1.1.b']) or pd.isnull(df['col_3.1.3.a']) or pd.isnull(df['col_3.1.3.b']):
                return str(incBlnk  + ' ' + '3.1.1.a' + ' (' + str(df['col_3.1.1.a']) + ' ) ' + ' + ' + ' ' + '3.1.1.b' + ' (' + str(df['col_3.1.1.b']) + ' ) ' + ' + ' + ' ' + '3.1.3.a' + ' (' + str(df['col_3.1.3.a']) + ' ) ' + ' + ' + ' ' + '3.1.3.b' + ' (' + str(df['col_3.1.3.b']) + ' ) '  + '>=' + '2.2' + ' (' + str(df['col_2.2']) + ' ) ' + ' + ' + '2.1.1.a' + ' (' + str(df['col_2.1.1.a']) + ' ) ' + ' + ' + '2.1.1.b' + ' (' + str(df['col_2.1.1.b']) + ' ) ')
            elif pd.isnull(df['col_2.2']) or pd.isnull(df['col_2.1.1.a']) or pd.isnull(df['col_2.1.1.b']):
                return str(incBlnk  + ' ' + '3.1.1.a' + ' (' + str(df['col_3.1.1.a']) + ' ) ' + ' + ' + ' ' + '3.1.1.b' + ' (' + str(df['col_3.1.1.b']) + ' ) ' + ' + ' + ' ' + '3.1.3.a' + ' (' + str(df['col_3.1.3.a']) + ' ) ' + ' + ' + ' ' + '3.1.3.b' + ' (' + str(df['col_3.1.3.b']) + ' ) '  + '>=' + '2.2' + ' (' + str(df['col_2.2']) + ' ) ' + ' + ' + '2.1.1.a' + ' (' + str(df['col_2.1.1.a']) + ' ) ' + ' + ' + '2.1.1.b' + ' (' + str(df['col_2.1.1.b']) + ' ) ')
        
        # Inconsistent
        elif df['col_3.1.1.a'] + df['col_3.1.1.b'] + df['col_3.1.3.a'] + df['col_3.1.3.b'] < df['col_2.2'] + df['col_2.1.1.a'] + df['col_2.1.1.b']:
            return str(inc  + ' ' + '3.1.1.a' + ' (' + str(df['col_3.1.1.a']) + ' ) ' + ' + ' + ' ' + '3.1.1.b' + ' (' + str(df['col_3.1.1.b']) + ' ) ' + ' + ' + ' ' + '3.1.3.a' + ' (' + str(df['col_3.1.3.a']) + ' ) ' + ' + ' + ' ' + '3.1.3.b' + ' (' + str(df['col_3.1.3.b']) + ' ) '  + '<' + '2.2' + ' (' + str(df['col_2.2']) + ' ) ' + ' + ' + '2.1.1.a' + ' (' + str(df['col_2.1.1.a']) + ' ) ' + ' + ' + '2.1.1.b' + ' (' + str(df['col_2.1.1.b']) + ' ) ')
        
        # Consistent
        elif df['col_3.1.1.a'] + df['col_3.1.1.b'] + df['col_3.1.3.a'] + df['col_3.1.3.b'] >= df['col_2.2'] + df['col_2.1.1.a'] + df['col_2.1.1.b']:
            return str(con + ' ' + '3.1.1.a' + ' (' + str(df['col_3.1.1.a']) + ' ) ' + ' + ' + ' ' + '3.1.1.b' + ' (' + str(df['col_3.1.1.b']) + ' ) ' + ' + ' + ' ' + '3.1.3.a' + ' (' + str(df['col_3.1.3.a']) + ' ) ' + ' + ' + ' ' + '3.1.3.b' + ' (' + str(df['col_3.1.3.b']) + ' ) '  + '>=' + '2.2' + ' (' + str(df['col_2.2']) + ' ) ' + ' + ' + '2.1.1.a' + ' (' + str(df['col_2.1.1.a']) + ' ) ' + ' + ' + '2.1.1.b' + ' (' + str(df['col_2.1.1.b']) + ' ) ')
    ...
    def res15(df):
        # If all elements are null
        if pd.isnull(df['col_3.1.1.a']) and pd.isnull(df['col_3.1.1.b']) and pd.isnull(df['col_3.1.3.a']) and pd.isnull(df['col_3.1.3.b']) and pd.isnull(df['col_2.2']) :
        ...
        # If any one element is null
        elif pd.isnull(df['col_3.1.1.a']) or pd.isnull(df['col_3.1.1.b']) or pd.isnull(df['col_3.1.3.a']) or pd.isnull(df['col_3.1.3.b']) or pd.isnull(df['col_2.2']) :
            if pd.isnull(df['col_3.1.1.a']) or pd.isnull(df['col_3.1.1.b']) or pd.isnull(df['col_3.1.3.a']) or pd.isnull(df['col_3.1.3.b']):
                return str(incBlnk  + ' ' + '3.1.1.a' + ' (' + str(df['col_3.1.1.a']) + ' ) ' + ' + ' + ' ' + '3.1.1.b' + ' (' + str(df['col_3.1.1.b']) + ' ) ' + ' + ' + ' ' + '3.1.3.a' + ' (' + str(df['col_3.1.3.a']) + ' ) ' + ' + ' + ' ' + '3.1.3.b' + ' (' + str(df['col_3.1.3.b']) + ' ) '  + '>=' + '2.3' + ' (' + str(df['col_2.3']) )
            elif pd.isnull(df['col_2.3']):
                return str(incBlnk  + ' ' + '3.1.1.a' + ' (' + str(df['col_3.1.1.a']) + ' ) ' + ' + ' + ' ' + '3.1.1.b' + ' (' + str(df['col_3.1.1.b']) + ' ) ' + ' + ' + ' ' + '3.1.3.a' + ' (' + str(df['col_3.1.3.a']) + ' ) ' + ' + ' + ' ' + '3.1.3.b' + ' (' + str(df['col_3.1.3.b']) + ' ) '  + '>=' + '2.3' + ' (' + str(df['col_2.3']) )
        
        # Inconsistent
        elif df['col_3.1.1.a'] + df['col_3.1.1.b'] + df['col_3.1.3.a'] + df['col_3.1.3.b'] < df['col_2.3']:
            return str(inc  + ' ' + '3.1.1.a' + ' (' + str(df['col_3.1.1.a']) + ' ) ' + ' + ' + ' ' + '3.1.1.b' + ' (' + str(df['col_3.1.1.b']) + ' ) ' + ' + ' + ' ' + '3.1.3.a' + ' (' + str(df['col_3.1.3.a']) + ' ) ' + ' + ' + ' ' + '3.1.3.b' + ' (' + str(df['col_3.1.3.b']) + ' ) '  + '<' + '2.3' + ' (' + str(df['col_2.3']) )
        
        # Consistent
        elif df['col_3.1.1.a'] + df['col_3.1.1.b'] + df['col_3.1.3.a'] + df['col_3.1.3.b'] >= df['col_2.3']:
            return str(con  + ' ' + '3.1.1.a' + ' (' + str(df['col_3.1.1.a']) + ' ) ' + ' + ' + ' ' + '3.1.1.b' + ' (' + str(df['col_3.1.1.b']) + ' ) ' + ' + ' + ' ' + '3.1.3.a' + ' (' + str(df['col_3.1.3.a']) + ' ) ' + ' + ' + ' ' + '3.1.3.b' + ' (' + str(df['col_3.1.3.b']) + ' ) '  + '>=' + '2.3' + ' (' + str(df['col_2.3']) )
    ...
    def res16(df):
        ...
        # If any one element is null
        elif pd.isnull(df['col_3.4.1']) or pd.isnull(df['col_3.1.1.a']) or pd.isnull(df['col_3.1.1.b']):
            if pd.isnull(df['col_3.4.1']):
    ...
    def res17(df):
        ...
        # If any one element is null
        elif pd.isnull(df['col_3.4.2']) or pd.isnull(df['col_3.4.1']):
            if pd.isnull(df['col_3.4.2']):
                return str(incBlnk  + ' ' + '3.4.2' + ' (' + str(df['col_3.4.2']) + ' ) ' + '<=' + '3.4.1' + ' (' + str(df['col_3.4.1']) + ' ) ')
            elif pd.isnull(float(df['col_3.4.1'])):
                return str(incBlnk  + ' ' + '3.4.2' + ' (' + str(df['col_3.4.2']) + ' ) ' + '<=' + '3.4.1' + ' (' + str(df['col_3.4.1']) + ' ) ')
        ...
        # Consistent
            ...
            return str(con  + ' ' + '3.4.2' + ' (' + str(df['col_3.4.2']) + ' ) ' + '<=' + '3.4.1' + ' (' + str(df['col_3.4.1']) + ' ) ')
    ...
    def res18(df):
        ...
        # If any one element is null
        elif pd.isnull(df['col_3.4.2.a']) or pd.isnull(df['col_3.4.2']):
            if pd.isnull(df['col_3.4.2.a']):
                return str(incBlnk  + ' ' + '3.4.2.a' + ' (' + str(df['col_3.4.2.a']) + ' ) ' + '<=' + '3.4.2' + ' (' + str(df['col_3.4.2']) + ' ) ')
            elif pd.isnull(float(df['col_3.4.2'])):
                return str(incBlnk  + ' ' + '3.4.2.a' + ' (' + str(df['col_3.4.2.a']) + ' ) ' + '<=' + '3.4.2' + ' (' + str(df['col_3.4.2']) + ' ) ')
        ...
        # Consistent
            ...
            return str(con  + ' ' + '3.4.2.a' + ' (' + str(df['col_3.4.2.a']) + ' ) ' + '<=' + '3.4.2' + ' (' + str(df['col_3.4.2']) + ' ) ')
    ...
    def res19(df):
        ...
        # If any one element is null
        elif pd.isnull(df['col_3.4.3']) or pd.isnull(df['col_3.1.1.a']) or pd.isnull(df['col_3.1.1.b']):
            if pd.isnull(df['col_3.4.3']):
    ...
    def res20(df):
        ...
        # If any one element is null
        elif pd.isnull(df['col_3.4.4']) or pd.isnull(df['col_3.1.1.a']) or pd.isnull(df['col_3.1.1.b']):
            if pd.isnull(df['col_3.4.4']):
    ...
    def res21(df):
        ...
        # If any one element is null
        elif pd.isnull(df['col_3.5.1.a']) or pd.isnull(df['col_3.5.1']):
            if pd.isnull(df['col_3.5.1.a']):
                return str(incBlnk  + ' ' + '3.5.1.a' + ' (' + str(df['col_3.5.1.a']) + ' ) ' + '<=' + '3.5.1' + ' (' + str(df['col_3.5.1']) + ' ) ')
            elif pd.isnull(float(df['col_3.5.1'])):
                return str(incBlnk  + ' ' + '3.5.1.a' + ' (' + str(df['col_3.5.1.a']) + ' ) ' + '<=' + '3.5.1' + ' (' + str(df['col_3.5.1']) + ' ) ')
        ...
        # Consistent
            ...
            return str(con  + ' ' + '3.5.1.a' + ' (' + str(df['col_3.5.1.a']) + ' ) ' + '<=' + '3.5.1' + ' (' + str(df['col_3.5.1']) + ' ) ')
    ...
    def res22(df):
        ...
        # If any one element is null
        elif pd.isnull(df['col_6.1.1.a']) or pd.isnull(df['col_6.1.1']):
            if pd.isnull(df['col_6.1.1.a']):
                return str(incBlnk  + ' ' + '6.1.1.a' + ' (' + str(df['col_6.1.1.a']) + ' ) ' + '<=' + '6.1.1' + ' (' + str(df['col_6.1.1']) + ' ) ')
            elif pd.isnull(float(df['col_6.1.1'])):
                return str(incBlnk  + ' ' + '6.1.1.a' + ' (' + str(df['col_6.1.1.a']) + ' ) ' + '<=' + '6.1.1' + ' (' + str(df['col_6.1.1']) + ' ) ')
        ...
        # Consistent
            ...
            return str(con  + ' ' + '6.1.1.a' + ' (' + str(df['col_6.1.1.a']) + ' ) ' + '<=' + '6.1.1' + ' (' + str(df['col_6.1.1']) + ' ) ')
    ...
    def res23(df):
        ...
        # If any one element is null
        elif pd.isnull(df['col_6.1.2.a']) or pd.isnull(df['col_6.1.2']):
            if pd.isnull(df['col_6.1.2.a']):
                return str(incBlnk  + ' ' + '6.1.2.a' + ' (' + str(df['col_6.1.2.a']) + ' ) ' + '<=' + '6.1.2' + ' (' + str(df['col_6.1.2']) + ' ) ')
            elif pd.isnull(float(df['col_6.1.2'])):
                return str(incBlnk  + ' ' + '6.1.2.a' + ' (' + str(df['col_6.1.2.a']) + ' ) ' + '<=' + '6.1.2' + ' (' + str(df['col_6.1.2']) + ' ) ')
        
        # Inconsistent
        elif df['col_6.1.2.a'] > df['col_6.1.2']:
            return str(incBlnk  + ' ' + '6.1.2.a' + ' (' + str(df['col_6.1.2.a']) + ' ) ' + '>' + '6.1.2' + ' (' + str(df['col_6.1.2']) + ' ) ')
        
        # Consistent
        elif df['col_6.1.2.a'] <= df['col_6.1.2']:
            return str(con  + ' ' + '6.1.2.a' + ' (' + str(df['col_6.1.2.a']) + ' ) ' + '<=' + '6.1.2' + ' (' + str(df['col_6.1.2']) + ' ) ')
    ...
    def res24(df):
        ...
        # If any one element is null
        elif pd.isnull(df['col_6.1.3.a']) or pd.isnull(df['col_6.1.3']):
            if pd.isnull(df['col_6.1.3.a']):
                return str(incBlnk  + ' ' + '6.1.3.a' + ' (' + str(df['col_6.1.3.a']) + ' ) ' + '<=' + '6.1.3' + ' (' + str(df['col_6.1.3']) + ' ) ')
            elif pd.isnull(float(df['col_6.1.3'])):
                return str(incBlnk  + ' ' + '6.1.3.a' + ' (' + str(df['col_6.1.3.a']) + ' ) ' + '<=' + '6.1.3' + ' (' + str(df['col_6.1.3']) + ' ) ')
        ...
        # Consistent
            ...
            return str(con  + ' ' + '6.1.3.a' + ' (' + str(df['col_6.1.3.a']) + ' ) ' + '<=' + '6.1.3' + ' (' + str(df['col_6.1.3']) + ' ) ')
    ...
    def res25(df):
        ...
        # If any one element is null
        elif pd.isnull(df['col_10.1.1.b']) or pd.isnull(df['col_10.1.1.c']) or pd.isnull(df['col_10.1.1.d']) or pd.isnull(df['col_10.1.1.a']) :
            if pd.isnull(df['col_10.1.1.b']) or pd.isnull(df['col_10.1.1.c']) or pd.isnull(df['col_10.1.1.d']):
            ...
            elif pd.isnull(df['col_10.1.1.a']):
                return str( incBlnk  + ' ' + '10.1.1.b' + ' (' + str(df['col_10.1.1.b']) + ' ) ' + ' + ' + '10.1.1.c' + ' (' + str(df['col_10.1.1.c']) + ' ) ' + ' + ' + '10.1.1.d' + ' (' + str(df['col_10.1.1.d']) + ' ) ' + ' ' + '<=' + ' ' + '10.1.1.a' + ' (' + str(df['col_10.1.1.a']) + ' ) '  )
        ...
        # Consistent
            ...
            return str( con  + ' ' + '10.1.1.b' + ' (' + str(df['col_10.1.1.b']) + ' ) ' + ' + ' + '10.1.1.c' + ' (' + str(df['col_10.1.1.c']) + ' ) ' + ' + ' + '10.1.1.d' + ' (' + str(df['col_10.1.1.d']) + ' ) ' + ' ' + '<=' + ' ' + '10.1.1.a' + ' (' + str(df['col_10.1.1.a']) + ' ) '  )
    ...
    def res26(df):
        ...
        # If any one element is null
        elif pd.isnull(df['col_12.3']) or pd.isnull(df['col_12.2']):
            if pd.isnull(df['col_12.3']):
                return str(incBlnk  + ' ' + '12.3' + ' (' + str(df['col_12.3']) + ' ) ' + '<=' + '12.2' + ' (' + str(df['col_12.2']) + ' ) ')
            elif pd.isnull(float(df['col_12.2'])):
                return str(incBlnk  + ' ' + '12.3' + ' (' + str(df['col_12.3']) + ' ) ' + '<=' + '12.2' + ' (' + str(df['col_12.2']) + ' ) ')
        ...
        # Consistent
            ...
            return str(con  + ' ' + '12.3' + ' (' + str(df['col_12.3']) + ' ) ' + '<=' + '12.2' + ' (' + str(df['col_12.2']) + ' ) ')
    ...
    def res27(df):
        ...
        # If any one element is null
        elif pd.isnull(df['col_12.4']) or pd.isnull(df['col_12.3.a']):
            if pd.isnull(df['col_12.4']):
                return str(incBlnk  + ' ' + '12.4' + ' (' + str(df['col_12.4']) + ' ) ' + '<=' + '12.3.a' + ' (' + str(df['col_12.3.a']) + ' ) ')
            elif pd.isnull(float(df['col_12.3.a'])):
                return str(incBlnk  + ' ' + '12.4' + ' (' + str(df['col_12.4']) + ' ) ' + '<=' + '12.3.a' + ' (' + str(df['col_12.3.a']) + ' ) ')
        ...
        # Consistent
            ...
            return str(con  + ' ' + '12.4' + ' (' + str(df['col_12.4']) + ' ) ' + '<=' + '12.3.a' + ' (' + str(df['col_12.3.a']) + ' ) ')
    ...
    def res28(df):
        ...
        # If any one element is null
        elif pd.isnull(df['col_12.5']) or pd.isnull(df['col_12.3.b']):
            if pd.isnull(df['col_12.5']):
                return str(incBlnk  + ' ' + '12.5' + ' (' + str(df['col_12.5']) + ' ) ' + '<=' + '12.3.b' + ' (' + str(df['col_12.3.b']) + ' ) ')
            elif pd.isnull(float(df['col_12.3.b'])):
                return str(incBlnk  + ' ' + '12.5' + ' (' + str(df['col_12.5']) + ' ) ' + '<=' + '12.3.b' + ' (' + str(df['col_12.3.b']) + ' ) ')
        ...
        # Consistent
            ...
            return str(con  + ' ' + '12.5' + ' (' + str(df['col_12.5']) + ' ) ' + '<=' + '12.3.b' + ' (' + str(df['col_12.3.b']) + ' ) ')
    ...
    def res29(df):
        ...
        # If any one element is null
        elif pd.isnull(df['col_12.6']) or pd.isnull(df['col_12.4']) or pd.isnull(df['col_12.5']) :
            if pd.isnull(df['col_12.6']):
                return str(blnk  + ' ' + '12.6' + ' (' + str(df['col_12.6']) + ' ) ' + '<=' + '12.4' + ' (' + str(df['col_12.4']) + ' ) ' + ' + ' + '12.5' + ' (' + str(df['col_12.5']) + ' ) ')
            elif pd.isnull(float(df['col_12.4'])) or pd.isnull(float(df['col_12.5'])):
                return str(blnk  + ' ' + '12.6' + ' (' + str(df['col_12.6']) + ' ) ' + '<=' + '12.4' + ' (' + str(df['col_12.4']) + ' ) ' + ' + ' + '12.5' + ' (' + str(df['col_12.5']) + ' ) ')
    ...
    def res30(df):
        ...
        # If any one element is null
        elif pd.isnull(df['col_12.4']) or pd.isnull(df['col_12.5']) or pd.isnull(df['col_12.2']):
            if pd.isnull(df['col_12.4']):
                return str(incBlnk  + ' ' + '12.4' + ' (' + str(df['col_12.4']) + ' ) ' + ' + ' + ' ' + '12.5' + ' (' + str(df['col_12.5']) + ' ) ' + '<=' + '12.2' + ' (' + str(df['col_12.2']) + ' ) ')
            elif pd.isnull(df['col_12.5']) or pd.isnull(df['col_12.2']):
                return str(incBlnk  + ' ' + '12.4' + ' (' + str(df['col_12.4']) + ' ) ' + ' + ' + ' ' + '12.5' + ' (' + str(df['col_12.5']) + ' ) ' + '<=' + '12.2' + ' (' + str(df['col_12.2']) + ' ) ')
        ...
        # Consistent
            ...
            return str(con  + ' ' + '12.4' + ' (' + str(df['col_12.4']) + ' ) ' + ' + ' + ' ' + '12.5' + ' (' + str(df['col_12.5']) + ' ) ' + '<=' + '12.2' + ' (' + str(df['col_12.2']) + ' ) ')
    ...
    def res31(df):
        ...
        # If any one element is null
        elif pd.isnull(df['col_12.6']) or pd.isnull(df['col_12.2']):
            if pd.isnull(df['col_12.6']):
    ...
    def res32(df):
        ...
        # If any one element is null
        elif pd.isnull(df['col_13.2.1']) or pd.isnull(df['col_13.2.2']) or pd.isnull(df['col_13.1.1']) or pd.isnull(df['col_13.1.2']) or pd.isnull(df['col_13.1.3']) or pd.isnull(df['col_13.1.4']) or pd.isnull(df['col_13.1.5']) or pd.isnull(df['col_13.1.6']) or pd.isnull(df['col_13.1.7']) or pd.isnull(df['col_13.1.8']) or pd.isnull(df['col_13.1.9']) or pd.isnull(df['col_13.1.10']) or pd.isnull(df['col_13.1.11']) or pd.isnull(df['col_13.1.12']) or pd.isnull(df['col_13.1.13']):
            if pd.isnull(df['col_13.2.1']) or pd.isnull(df['col_13.2.2']):
            ...
            elif pd.isnull(df['col_13.1.1']) or pd.isnull(df['col_13.1.2']) or pd.isnull(df['col_13.1.3']) or pd.isnull(df['col_13.1.4']) or pd.isnull(df['col_13.1.5']) or pd.isnull(df['col_13.1.6']) or pd.isnull(df['col_13.1.7']) or pd.isnull(df['col_13.1.8']) or pd.isnull(df['col_13.1.9']) or pd.isnull(df['col_13.1.10']) or pd.isnull(df['col_13.1.11']) or pd.isnull(df['col_13.1.12']) or pd.isnull(df['col_13.1.13']):
                return str(incBlnk  + ' ' + '13.2.1' + ' (' + str(df['col_13.2.1']) + ' ) ' + ' + ' + ' ' + '13.2.2' + ' (' + str(df['col_13.2.2']) + ' ) ' + '<=' + '13.1.1' + ' (' + str(df['col_13.1.1']) + ' ) ' + ' + ' + '13.1.2' + ' (' + str(df['col_13.1.2']) + ' ) ' + ' + ' + '13.1.3' + ' (' + str(df['col_13.1.3']) + ' ) ' + ' + ' + '13.1.4' + ' (' + str(df['col_13.1.4']) + ' ) ' + ' + ' + '13.1.5' + ' (' + str(df['col_13.1.5']) + ' ) ' + ' + ' + '13.1.6' + ' (' + str(df['col_13.1.6']) + ' ) ' + ' + ' + '13.1.7' + ' (' + str(df['col_13.1.7']) + ' ) ' + ' + ' + '13.1.8' + ' (' + str(df['col_13.1.8']) + ' ) ' + ' + ' + '13.1.9' + ' (' + str(df['col_13.1.9']) + ' ) ' + ' + ' + '13.1.10' + ' (' + str(df['col_13.1.10']) + ' ) ' + ' + ' + '13.1.11' + ' (' + str(df['col_13.1.11']) + ' ) ' + ' + ' + '13.1.12' + ' (' + str(df['col_13.1.12']) + ' ) ' + ' + ' + '13.1.13' + ' (' + str(df['col_13.1.13']) + ' ) ' )
        
        # Inconsistent
        elif df['col_13.2.1'] + df['col_13.2.2'] > df['col_13.1.1'] + df['col_13.1.2'] + df['col_13.1.3'] + df['col_13.1.4'] + df['col_13.1.5'] + df['col_13.1.6'] + df['col_13.1.7'] + df['col_13.1.8'] + df['col_13.1.9'] + df['col_13.1.10'] + df['col_13.1.11'] + df['col_13.1.12'] + df['col_13.1.13']:
        ...
        # Consistent
            ...
            return str(con  + ' ' + '13.2.1' + ' (' + str(df['col_13.2.1']) + ' ) ' + ' + ' + ' ' + '13.2.2' + ' (' + str(df['col_13.2.2']) + ' ) ' + '<=' + '13.1.1' + ' (' + str(df['col_13.1.1']) + ' ) ' + ' + ' + '13.1.2' + ' (' + str(df['col_13.1.2']) + ' ) ' + ' + ' + '13.1.3' + ' (' + str(df['col_13.1.3']) + ' ) ' + ' + ' + '13.1.4' + ' (' + str(df['col_13.1.4']) + ' ) ' + ' + ' + '13.1.5' + ' (' + str(df['col_13.1.5']) + ' ) ' + ' + ' + '13.1.6' + ' (' + str(df['col_13.1.6']) + ' ) ' + ' + ' + '13.1.7' + ' (' + str(df['col_13.1.7']) + ' ) ' + ' + ' + '13.1.8' + ' (' + str(df['col_13.1.8']) + ' ) ' + ' + ' + '13.1.9' + ' (' + str(df['col_13.1.9']) + ' ) ' + ' + ' + '13.1.10' + ' (' + str(df['col_13.1.10']) + ' ) ' + ' + ' + '13.1.11' + ' (' + str(df['col_13.1.11']) + ' ) ' + ' + ' + '13.1.12' + ' (' + str(df['col_13.1.12']) + ' ) ' + ' + ' + '13.1.13' + ' (' + str(df['col_13.1.13']) + ' ) ' )
    ...
    def res33(df):
        ...
        # If any one element is null
        elif pd.isnull(df['col_13.3.1.a']) or pd.isnull(df['col_13.2.1']) or pd.isnull(df['col_13.2.2']) :
            if pd.isnull(df['col_13.3.1.a']):
        ...
        # Consistent
            ...
            return str(con  + ' ' + '13.3.1.a' + ' (' + str(df['col_13.3.1.a']) + ' ) ' + '<=' + '13.2.1' + ' (' + str(df['col_13.2.1']) + ' ) ' + ' + ' + '13.2.2' + ' (' + str(df['col_13.2.2']) + ' ) ')
    ...
    def res34(df):
        ...
        # If any one element is null
        elif pd.isnull(df['col_13.10.2.a']) or pd.isnull(df['col_13.10.1.a']):
            if pd.isnull(df['col_13.10.2.a']):
                return str(incBlnk  + ' ' + '13.10.2.a' + ' (' + str(df['col_13.10.2.a']) + ' ) ' + '<=' + '13.10.1.a' + ' (' + str(df['col_13.10.1.a']) + ' ) ')
            elif pd.isnull(float(df['col_13.10.1.a'])):
                return str(incBlnk  + ' ' + '13.10.2.a' + ' (' + str(df['col_13.10.2.a']) + ' ) ' + '<=' + '13.10.1.a' + ' (' + str(df['col_13.10.1.a']) + ' ) ')
        ...
        # Consistent
            ...
            return str(con  + ' ' + '13.10.2.a' + ' (' + str(df['col_13.10.2.a']) + ' ) ' + '<=' + '13.10.1.a' + ' (' + str(df['col_13.10.1.a']) + ' ) ')
    ...
    def res35(df):
        ...
        # If any one element is null
        elif pd.isnull(df['col_13.10.2.b']) or pd.isnull(df['col_13.10.1.b']):
            if pd.isnull(df['col_13.10.2.b']):
                return str(incBlnk  + ' ' + '13.10.2.b' + ' (' + str(df['col_13.10.2.b']) + ' ) ' + '<=' + '13.10.1.b' + ' (' + str(df['col_13.10.1.b']) + ' ) ')
            elif pd.isnull(float(df['col_13.10.1.b'])):
                return str(incBlnk  + ' ' + '13.10.2.b' + ' (' + str(df['col_13.10.2.b']) + ' ) ' + '<=' + '13.10.1.b' + ' (' + str(df['col_13.10.1.b']) + ' ) ')
    ...
    def res36(df):
        ...
        # If any one element is null
        elif pd.isnull(df['col_13.10.3.b']) or pd.isnull(df['col_13.10.3.a']):
            if pd.isnull(df['col_13.10.3.b']):
                return str(incBlnk  + ' ' + '13.10.3.b' + ' (' + str(df['col_13.10.3.b']) + ' ) ' + '<=' + '13.10.3.a' + ' (' + str(df['col_13.10.3.a']) + ' ) ')
            elif pd.isnull(float(df['col_13.10.3.a'])):
                return str(incBlnk  + ' ' + '13.10.3.b' + ' (' + str(df['col_13.10.3.b']) + ' ) ' + '<=' + '13.10.3.a' + ' (' + str(df['col_13.10.3.a']) + ' ) ')
    ...
    def res37(df):
        ...
        # If any one element is null
        elif pd.isnull(df['col_14.2.1']) or pd.isnull(df['col_14.1.1']) or pd.isnull(df['col_14.1.2']) :
            if pd.isnull(df['col_14.2.1']):
                return str(incBlnk  + ' ' + '14.2.1' + ' (' + str(df['col_14.2.1']) + ' ) ' + '<=' + '14.1.1' + ' (' + str(df['col_14.1.1']) + ' ) ' + ' + ' + '14.1.2' + ' (' + str(df['col_14.1.2']) + ' ) ')
            elif pd.isnull(float(df['col_14.1.1'])) or pd.isnull(float(df['col_14.1.2'])):
                return str(incBlnk  + ' ' + '14.2.1' + ' (' + str(df['col_14.2.1']) + ' ) ' + '<=' + '14.1.1' + ' (' + str(df['col_14.1.1']) + ' ) ' + ' + ' + '14.1.2' + ' (' + str(df['col_14.1.2']) + ' ) ')
        
        # Inconsistent
        elif df['col_14.2.1'] > df['col_14.1.1'] + df['col_14.1.2']:
            return str(inc  + ' ' + '14.2.1' + ' (' + str(df['col_14.2.1']) + ' ) ' + '>' + '14.1.1' + ' (' + str(df['col_14.1.1']) + ' ) ' + ' + ' + '14.1.2' + ' (' + str(df['col_14.1.2']) + ' ) ')
        
        # Consistent
        elif df['col_14.2.1'] <= df['col_14.1.1'] + df['col_14.1.2']:
            return str(con  + ' ' + '14.2.1' + ' (' + str(df['col_14.2.1']) + ' ) ' + '<=' + '14.1.1' + ' (' + str(df['col_14.1.1']) + ' ) ' + ' + ' + '14.1.2' + ' (' + str(df['col_14.1.2']) + ' ) ')
    ...
    def res38(df):
        ...
        # If any one element is null
        elif pd.isnull(df['col_14.2.2']) or pd.isnull(df['col_14.2.1']):
            if pd.isnull(df['col_14.2.2']):
                return str(incBlnk  + ' ' + '14.2.2' + ' (' + str(df['col_14.2.2']) + ' ) ' + '<=' + '14.2.1' + ' (' + str(df['col_14.2.1']) + ' ) ')
            elif pd.isnull(float(df['col_14.2.1'])):
                return str(incBlnk  + ' ' + '14.2.2' + ' (' + str(df['col_14.2.2']) + ' ) ' + '<=' + '14.2.1' + ' (' + str(df['col_14.2.1']) + ' ) ')
        ...
        # Consistent
            ...
            return str(con  + ' ' + '14.2.2' + ' (' + str(df['col_14.2.2']) + ' ) ' + '<=' + '14.2.1' + ' (' + str(df['col_14.2.1']) + ' ) ')
    ...
    def res39(df):
        ...
        # If any one element is null
        elif pd.isnull(df['col_14.3.1.b']) or pd.isnull(df['col_14.3.1.a']):
            if pd.isnull(df['col_14.3.1.b']):
                return str(incBlnk  + ' ' + '14.3.1.b' + ' (' + str(df['col_14.3.1.b']) + ' ) ' + '<=' + '14.3.1.a' + ' (' + str(df['col_14.3.1.a']) + ' ) ')
            elif pd.isnull(float(df['col_14.3.1.a'])):
                return str(incBlnk  + ' ' + '14.3.1.b' + ' (' + str(df['col_14.3.1.b']) + ' ) ' + '<=' + '14.3.1.a' + ' (' + str(df['col_14.3.1.a']) + ' ) ')
        ...
        # Consistent
            ...
            return str(con  + ' ' + '14.3.1.b' + ' (' + str(df['col_14.3.1.b']) + ' ) ' + '<=' + '14.3.1.a' + ' (' + str(df['col_14.3.1.a']) + ' ) ')
    ...
    def res40(df):
        ...
        # If any one element is null
        elif pd.isnull(df['col_14.3.1.d']) or pd.isnull(df['col_14.3.1.c']):
            if pd.isnull(df['col_14.3.1.d']):
                return str(incBlnk  + ' ' + '14.3.1.d' + ' (' + str(df['col_14.3.1.d']) + ' ) ' + '<=' + '14.3.1.c' + ' (' + str(df['col_14.3.1.c']) + ' ) ')
            elif pd.isnull(float(df['col_14.3.1.c'])):
                return str(incBlnk  + ' ' + '14.3.1.d' + ' (' + str(df['col_14.3.1.d']) + ' ) ' + '<=' + '14.3.1.c' + ' (' + str(df['col_14.3.1.c']) + ' ) ')        
    ...
    def res41(df):
        ...
        # If any one element is null
        elif pd.isnull(df['col_14.3.2.b']) or pd.isnull(df['col_14.3.2.a']):
            if pd.isnull(df['col_14.3.2.b']):
                return str(incBlnk  + ' ' + '14.3.2.b' + ' (' + str(df['col_14.3.2.b']) + ' ) ' + '<=' + '14.3.2.a' + ' (' + str(df['col_14.3.2.a']) + ' ) ')
            elif pd.isnull(float(df['col_14.3.2.b'])):
                return str(incBlnk  + ' ' + '14.3.2.b' + ' (' + str(df['col_14.3.2.b']) + ' ) ' + '<=' + '14.3.2.a' + ' (' + str(df['col_14.3.2.a']) + ' ) ')        
        ...
        # Consistent
            ...
            return str(con  + ' ' + '14.3.2.b' + ' (' + str(df['col_14.3.2.b']) + ' ) ' + '<=' + '14.3.2.a' + ' (' + str(df['col_14.3.2.a']) + ' ) ')
    ...
    def res42(df):
        ...
        # If any one element is null
        elif pd.isnull(df['col_14.3.2.d']) or pd.isnull(df['col_14.3.2.c']):
            if pd.isnull(df['col_14.3.2.d']):
                return str(incBlnk  + ' ' + '14.3.2.d' + ' (' + str(df['col_14.3.2.d']) + ' ) ' + '<=' + '14.3.2.c' + ' (' + str(df['col_14.3.2.c']) + ' ) ')
            elif pd.isnull(float(df['col_14.3.2.c'])):
                return str(incBlnk  + ' ' + '14.3.2.d' + ' (' + str(df['col_14.3.2.d']) + ' ) ' + '<=' + '14.3.2.c' + ' (' + str(df['col_14.3.2.c']) + ' ) ')        
        ...
        # Consistent
            ...
            return str(con  + ' ' + '14.3.2.d' + ' (' + str(df['col_14.3.2.d']) + ' ) ' + '<=' + '14.3.2.c' + ' (' + str(df['col_14.3.2.c']) + ' ) ')
    ...
    def res43(df):
        ...
        # If any one element is null
        elif pd.isnull(df['col_14.3.3.b']) or pd.isnull(df['col_14.3.3.a']):
            if pd.isnull(df['col_14.3.3.b']):
                return str(incBlnk  + ' ' + '14.3.3.b' + ' (' + str(df['col_14.3.3.b']) + ' ) ' + '<=' + '14.3.3.a' + ' (' + str(df['col_14.3.3.a']) + ' ) ')
            elif pd.isnull(float(df['col_14.3.3.b'])):
                return str(incBlnk  + ' ' + '14.3.3.b' + ' (' + str(df['col_14.3.3.b']) + ' ) ' + '<=' + '14.3.3.a' + ' (' + str(df['col_14.3.3.a']) + ' ) ')        
        ...
        # Consistent
            ...
            return str(con  + ' ' + '14.3.3.b' + ' (' + str(df['col_14.3.3.b']) + ' ) ' + '<=' + '14.3.3.a' + ' (' + str(df['col_14.3.3.a']) + ' ) ')
    ...
    def res44(df):
        ...
        # If any one element is null
        elif pd.isnull(df['col_14.3.3.d']) or pd.isnull(df['col_14.3.3.c']):
            if pd.isnull(df['col_14.3.3.d']):
                return str(incBlnk  + ' ' + '14.3.3.d' + ' (' + str(df['col_14.3.3.d']) + ' ) ' + '<=' + '14.3.3.c' + ' (' + str(df['col_14.3.3.c']) + ' ) ')
            elif pd.isnull(float(df['col_14.3.3.c'])):
                return str(incBlnk  + ' ' + '14.3.3.d' + ' (' + str(df['col_14.3.3.d']) + ' ) ' + '<=' + '14.3.3.c' + ' (' + str(df['col_14.3.3.c']) + ' ) ')        
        ...
        # Consistent
            ...
            return str(con  + ' ' + '14.3.3.d' + ' (' + str(df['col_14.3.3.d']) + ' ) ' + '<=' + '14.3.3.c' + ' (' + str(df['col_14.3.3.c']) + ' ) ')
    ...
    def res45(df):
        ...
        # If any one element is null
        elif pd.isnull(df['col_14.3.4.b']) or pd.isnull(df['col_14.3.4.a']):
            if pd.isnull(df['col_14.3.4.b']):
                return str(incBlnk  + ' ' + '14.3.4.b' + ' (' + str(df['col_14.3.4.b']) + ' ) ' + '<=' + '14.3.4.a' + ' (' + str(df['col_14.3.4.a']) + ' ) ')
            elif pd.isnull(float(df['col_14.3.4.a'])):
                return str(incBlnk  + ' ' + '14.3.4.b' + ' (' + str(df['col_14.3.4.b']) + ' ) ' + '<=' + '14.3.4.a' + ' (' + str(df['col_14.3.4.a']) + ' ) ')        
        ...
        # Consistent
            ...
            return str(con  + ' ' + '14.3.4.b' + ' (' + str(df['col_14.3.4.b']) + ' ) ' + '<=' + '14.3.4.a' + ' (' + str(df['col_14.3.4.a']) + ' ) ')
    ...
    def res46(df):
        ...
        # If any one element is null
        elif pd.isnull(df['col_14.3.4.d']) or pd.isnull(df['col_14.3.4.c']):
            if pd.isnull(df['col_14.3.4.d']):
                return str(incBlnk  + ' ' + '14.3.4.d' + ' (' + str(df['col_14.3.4.d']) + ' ) ' + '<=' + '14.3.4.c' + ' (' + str(df['col_14.3.4.c']) + ' ) ')
            elif pd.isnull(float(df['col_14.3.4.c'])):
                return str(incBlnk  + ' ' + '14.3.4.d' + ' (' + str(df['col_14.3.4.d']) + ' ) ' + '<=' + '14.3.4.c' + ' (' + str(df['col_14.3.4.c']) + ' ) ')
    ...
    def res47(df):
        ...
        # If any one element is null
        elif pd.isnull(df['col_14.4.1.b']) or pd.isnull(df['col_14.4.1.a']):
            if pd.isnull(df['col_14.4.1.b']):
                return str(incBlnk  + ' ' + '14.4.1.b' + ' (' + str(df['col_14.4.1.b']) + ' ) ' + '<=' + '14.4.1.a' + ' (' + str(df['col_14.4.1.a']) + ' ) ')
            elif pd.isnull(float(df['col_14.4.1.a'])):
                return str(incBlnk  + ' ' + '14.4.1.b' + ' (' + str(df['col_14.4.1.b']) + ' ) ' + '<=' + '14.4.1.a' + ' (' + str(df['col_14.4.1.a']) + ' ) ')
        ...
        # Consistent
            ...
            return str(con  + ' ' + '14.4.1.b' + ' (' + str(df['col_14.4.1.b']) + ' ) ' + '<=' + '14.4.1.a' + ' (' + str(df['col_14.4.1.a']) + ' ) ')
    ...
    def res48(df):
        ...
        # If any one element is null
        elif pd.isnull(df['col_14.4.2.b']) or pd.isnull(df['col_14.4.2.a']):
            if pd.isnull(df['col_14.4.2.b']):
                return str(incBlnk  + ' ' + '14.4.2.b' + ' (' + str(df['col_14.4.2.b']) + ' ) ' + '<=' + '14.4.2.a' + ' (' + str(df['col_14.4.2.a']) + ' ) ')
            elif pd.isnull(float(df['col_14.4.2.a'])):
                return str(incBlnk  + ' ' + '14.4.2.b' + ' (' + str(df['col_14.4.2.b']) + ' ) ' + '<=' + '14.4.2.a' + ' (' + str(df['col_14.4.2.a']) + ' ) ')
        ...
        # Consistent
            ...
            return str(con  + ' ' + '14.4.2.b' + ' (' + str(df['col_14.4.2.b']) + ' ) ' + '<=' + '14.4.2.a' + ' (' + str(df['col_14.4.2.a']) + ' ) ')
    ...
    def res49(df):
        ...
        # Consistent
            ...
            return str(con  + ' ' + '14.4.3.b' + ' (' + str(df['col_14.4.3.b']) + ' ) ' + '<=' + '14.4.3.a' + ' (' + str(df['col_14.4.3.a']) + ' ) ')
    ...
    def res50(df):
        ...
        # If any one element is null
        elif pd.isnull(df['col_15.1.1.a']) or pd.isnull(df['col_15.1.1.b']) or pd.isnull(df['col_15.1.2.a']) or pd.isnull(df['col_15.1.2.b']) or pd.isnull(df['col_15.1.3.a']) or pd.isnull(df['col_15.1.3.b']) or pd.isnull(df['col_15.2.1']) or pd.isnull(df['col_15.2.2']) or pd.isnull(df['col_15.2.3']) or pd.isnull(df['col_15.2.4']):
            if pd.isnull(df['col_15.1.1.a']) or pd.isnull(df['col_15.1.1.b']) or pd.isnull(df['col_15.1.2.a']) or pd.isnull(df['col_15.1.2.b']) or pd.isnull(df['col_15.1.3.a']) or pd.isnull(df['col_15.1.3.b']):
            ...
            elif pd.isnull(df['col_15.2.1']) or pd.isnull(df['col_15.2.2']) or pd.isnull(df['col_15.2.3']) or pd.isnull(df['col_15.2.4']):
                return str(incBlnk  + ' ' + '15.1.1.a' + ' (' + str(df['col_15.1.1.a']) + ' ) ' +  '15.1.1.b' + ' (' + str(df['col_15.1.1.b']) + ' ) ' +  '15.1.2.a' + ' (' + str(df['col_15.1.2.a']) + ' ) ' +  '15.1.2.b' + ' (' + str(df['col_15.1.2.b']) + ' ) ' +  '15.1.3.a' + ' (' + str(df['col_15.1.3.b']) + ' ) ' + '=='  +  '15.2.1' + ' (' + str(df['col_15.2.1']) + ' ) '+  '15.2.2' + ' (' + str(df['col_15.2.2']) + ' ) '+  '15.2.3' + ' (' + str(df['col_15.2.3']) + ' ) '+  '15.2.4' + ' (' + str(df['col_15.2.4']) + ' ) ')
        ...
        # Consistent
            ...
            return str(con  + ' ' + '15.1.1.a' + ' (' + str(df['col_15.1.1.a']) + ' ) ' +  '15.1.1.b' + ' (' + str(df['col_15.1.1.b']) + ' ) ' +  '15.1.2.a' + ' (' + str(df['col_15.1.2.a']) + ' ) ' +  '15.1.2.b' + ' (' + str(df['col_15.1.2.b']) + ' ) ' +  '15.1.3.a' + ' (' + str(df['col_15.1.3.b']) + ' ) ' + '=='  +  '15.2.1' + ' (' + str(df['col_15.2.1']) + ' ) '+  '15.2.2' + ' (' + str(df['col_15.2.2']) + ' ) '+  '15.2.3' + ' (' + str(df['col_15.2.3']) + ' ) '+  '15.2.4' + ' (' + str(df['col_15.2.4']) + ' ) ')
    ...
    def res51(df):
        ...
        # If any one element is null
        elif pd.isnull(df['col_15.1.4.a']) or pd.isnull(df['col_15.1.4.b']) or pd.isnull(df['col_15.3.1']) or pd.isnull(df['col_15.3.2']) or pd.isnull(df['col_15.3.3']) or pd.isnull(df['col_15.3.4']) or pd.isnull(df['col_15.3.5']):
            if pd.isnull(df['col_15.1.4.a']) or pd.isnull(df['col_15.1.4.b']):
            ...
            elif pd.isnull(df['col_15.3.1']) or pd.isnull(df['col_15.3.2']) or pd.isnull(df['col_15.3.3']) or pd.isnull(df['col_15.3.4']) or pd.isnull(df['col_15.3.5']):
                return str(incBlnk  + ' ' + '15.1.4.a' + ' (' + str(df['col_15.1.4.a']) + ' ) ' + ' + ' +  '15.1.4.b' + ' (' + str(df['col_15.1.4.b']) + ' ) ' + ' == ' +  '15.3.1' + ' (' + str(df['col_15.3.1']) + ' ) ' + ' + ' +  '15.3.2' + ' (' + str(df['col_15.3.2']) + ' ) ' + ' + ' +  '15.3.3' + ' (' + str(df['col_15.3.3']) + ' ) ' + ' + ' +  '15.3.4' + ' (' + str(df['col_15.3.4']) + ' ) ' + ' + ' +  '15.3.5' + ' (' + str(df['col_15.3.5']) + ' ) ')
    ...
    def res52(df):
        ...
        # If any one element is null
        elif pd.isnull(df['col_15.5.1']) or pd.isnull(df['col_15.5.2']) or pd.isnull(df['col_15.5.3']) or pd.isnull(df['col_15.5.4']) or pd.isnull(df['col_15.5.5']) or pd.isnull(df['col_15.5.6']) or pd.isnull(df['col_15.5.7']) or pd.isnull(df['col_15.5.8']):
            if pd.isnull(df['col_15.5.1']) or pd.isnull(df['col_15.5.2']) or pd.isnull(df['col_15.5.3']) or pd.isnull(df['col_15.5.4']) or pd.isnull(df['col_15.5.5']) or pd.isnull(df['col_15.5.6']) or pd.isnull(df['col_15.5.7']):
            ...
            elif pd.isnull(df['col_15.5.8']):
                return str(incBlnk  + ' ' + '15.5.1' + ' (' + str(df['col_15.5.1']) + ' ) ' + ' + ' +  '15.5.2' + ' (' + str(df['col_15.5.2']) + ' ) ' + ' + ' +  '15.5.3' + ' (' + str(df['col_15.5.3']) + ' ) ' + ' + ' +  '15.5.4' + ' (' + str(df['col_15.5.4']) + ' ) ' + ' + ' +  '15.5.5' + ' (' + str(df['col_15.5.5']) + ' ) ' + ' + ' +  '15.5.6' + ' (' + str(df['col_15.5.6']) + ' ) ' + ' + ' +  '15.5.7' + ' (' + str(df['col_15.5.7']) + ' ) ' + '==' +  '15.5.8' + ' (' + str(df['col_15.5.8']) + ' ) ')
        
        # Inconsistent
        elif df['col_15.5.1'] + df['col_15.5.2'] != df['col_15.5.3'] + df['col_15.5.4'] + df['col_15.5.5'] + df['col_15.5.6'] + df['col_15.5.7'] != df['col_15.5.8']:
    ...
    def res53(df):
        ...
        # If any one element is null
        elif pd.isnull(df['col_15.5.1']) or pd.isnull(df['col_15.5.2']) or pd.isnull(df['col_15.5.3']) or pd.isnull(df['col_15.5.4']) or pd.isnull(df['col_15.5.5']) or pd.isnull(df['col_15.5.6']) or pd.isnull(df['col_15.5.7']) or pd.isnull(df['col_15.5.8.a']) or pd.isnull(df['col_15.5.8.b']) or pd.isnull(df['col_15.5.8.c']) or pd.isnull(df['col_15.5.8.d']):
            if pd.isnull(df['col_15.5.1']) or pd.isnull(df['col_15.5.2']) or pd.isnull(df['col_15.5.3']) or pd.isnull(df['col_15.5.4']) or pd.isnull(df['col_15.5.5']) or pd.isnull(df['col_15.5.6']) or pd.isnull(df['col_15.5.7']):
            ...
            elif pd.isnull(df['col_15.5.8.a']) or pd.isnull(df['col_15.5.8.b']) or pd.isnull(df['col_15.5.8.c']) or pd.isnull(df['col_15.5.8.d']):
                return str(incBlnk   + ' ' + '15.5.1' + ' (' + str(df['col_15.5.1']) + ' ) ' + ' + ' +  '15.5.2' + ' (' + str(df['col_15.5.2']) + ' ) ' + ' + ' +  '15.5.3' + ' (' + str(df['col_15.5.3']) + ' ) ' + ' + ' +  '15.5.4' + ' (' + str(df['col_15.5.4']) + ' ) ' + ' + ' +  '15.5.5' + ' (' + str(df['col_15.5.5']) + ' ) ' + ' + ' +  '15.5.6' + ' (' + str(df['col_15.5.6']) + ' ) ' + ' + ' +  '15.5.7' + ' (' + str(df['col_15.5.7']) + ' ) ' + '==' +  '15.5.8.a' + ' (' + str(df['col_15.5.8.a']) + ' ) ' + ' + ' +  '15.5.8.b' + ' (' + str(df['col_15.5.8.b']) + ' ) ' + ' + ' +  '15.5.8.c' + ' (' + str(df['col_15.5.8.c']) + ' ) ' + ' + ' +  '15.5.8.d' + ' (' + str(df['col_15.5.8.d']) + ' ) ')
        ...
        # Consistent
            ...
            return str(con  + ' ' + '15.5.1' + ' (' + str(df['col_15.5.1']) + ' ) ' + ' + ' +  '15.5.2' + ' (' + str(df['col_15.5.2']) + ' ) ' + ' + ' +  '15.5.3' + ' (' + str(df['col_15.5.3']) + ' ) ' + ' + ' +  '15.5.4' + ' (' + str(df['col_15.5.4']) + ' ) ' + ' + ' +  '15.5.5' + ' (' + str(df['col_15.5.5']) + ' ) ' + ' + ' +  '15.5.6' + ' (' + str(df['col_15.5.6']) + ' ) ' + ' + ' +  '15.5.7' + ' (' + str(df['col_15.5.7']) + ' ) ' + '==' +  '15.5.8.a' + ' (' + str(df['col_15.5.8.a']) + ' ) ' + ' + ' +  '15.5.8.b' + ' (' + str(df['col_15.5.8.b']) + ' ) ' + ' + ' +  '15.5.8.c' + ' (' + str(df['col_15.5.8.c']) + ' ) ' + ' + ' +  '15.5.8.d' + ' (' + str(df['col_15.5.8.d']) + ' ) ')
